...
const REPORT_EXPORT_INVOKE_METHOD_NAMES = {
  SHOW_ITEM_IN_FOLDER: 'showItemInFolder',
  GET_REPORT_FOLDER_WRITE_PERM: 'getReportFolderWritePerm'
}
...
const INVOKE_CHANNEL_MAP = new Map([
  ...
  [CHANNEL_NAMES.REPORT_EXPORT, REPORT_EXPORT_INVOKE_METHOD_NAMES]
])
